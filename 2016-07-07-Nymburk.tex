...
vyštěkne: \uv{Proč toho psa neodvážeš, copak nevidíš jak chudák trpí?}

\uv{Ale\dots,} stihnu jen já.

\uv{Takovýmu spratkovi svěří psa a pak to takhle vypadá, pani,} přidala se
druhá.

\uv{Koukej toho psa okamžitě odvázat nebo uvidíš, smrade jeden,} zaječela
třetí.
...
\uv{To támhleten kluk ho odvázal, my mu říkali ať to nedělá,} zaznělo ze
